  ...
  <div class="page">
    ...
    <div class="page-header">
      <div>
        ...
        <div class="page-subtitle">BANK NIFTY Options · VWAP+EMA Breakout · 5-min candles</div>
      </div>
    ...
    <div class="card engine-card">
      ...
      <div class="strat-note">
        VWAP + EMA(20) · Dynamic SL (12–22%) · Trailing SL from +20% · RSI + Volume filters · Max 2 trades/day · 9:50–14:00 entries · Force exit 3:20 PM · Lot size: 30
      </div>
    </div>
